...
module.exports = {
  ...
  win: {
    ...
    // REJECT every future update. Two entries: the full DN for the strict comparison, the
    // bare CN as a fallback should the certificate be reissued with a different L or C.
    // The subject is the validated organisation, never the Azure account name.
