...
OpenMasq handles other people's personal data. Two things follow, and they are part of
this code rather than a separate rule:

- **Never paste real personal data into an issue, a pull request, or a test fixture.**
  Fixtures in this repository are synthetic on purpose, and a check enforces it. If you
  need to describe a detection failure, describe the *shape* of the value, not the value.
- **Report a suspected vulnerability privately**, through the process in
  [`SECURITY.md`](SECURITY.md) — not in a public issue. Disclosing a hole publicly before
  a fix ships puts real users at risk, and that is the opposite of what this project is
  for.
...
community leaders responsible for enforcement at **support@openmasq.com**. All complaints
