...
export const modelCatalogB: Record<string, Messages["modelCatalog"]["models"][string]> = {
  ...
  "qwen3.5-397b-a17b": {
    strengths: ["Très grand MoE open-weight, multimodal", "Inclus avec votre compte"],
  ...
  "gemma-4-26b-a4b-it": {
    strengths: ["Léger, rapide, multimodal (open-weight)", "Inclus avec votre compte"],
    weaknesses: ["Capacités moyennes"],
    bestFor: "Tâches courantes économiques sans clé API",
  },
  "mistral-medium-3.5-128b": {
    strengths: ["Équilibré et multimodal", "Inclus avec votre compte"],
    weaknesses: ["Modèle propriétaire (hébergé)"],
    bestFor: "Usage général équilibré sans clé API",
  },
  "llama-3.3-70b-instruct": {
    strengths: ["Généraliste open-weight solide", "Inclus avec votre compte"],
  ...
  "pixtral-12b-2409": {
    strengths: ["Multimodal léger et économique", "Inclus avec votre compte"],
    weaknesses: ["Capacités moyennes"],
    bestFor: "Vision économique sans clé API",
  },
  "mistral-small-3.2-24b-instruct-2506": {
    strengths: ["Compact, multimodal, très économique", "Inclus avec votre compte"],
  ...
  "gpt-oss-120b": {
    strengths: ["Poids ouverts d'OpenAI, bon rapport perf/prix", "Inclus avec votre compte"],
    weaknesses: ["Texte seul"],
    bestFor: "Raisonnement économique open-weight sans clé API",
  },
  "gemma-3-27b-it": {
    strengths: ["Multimodal open-weight (Google)", "Inclus avec votre compte"],
    weaknesses: ["Génération précédente (Gemma 3)"],
    bestFor: "Vision généraliste sans clé API",
  },
  "holo2-30b-a3b": {
    strengths: ["MoE multimodal open-weight, rapide", "Inclus avec votre compte"],
