/**
 * The EN catalogue's « modelCatalogB » slice — translated from the source (`../fr/modelCatalogB.ts`).
 */
...
export const modelCatalogB: Record<string, Messages["modelCatalog"]["models"][string]> = {
  ...
  "qwen3.5-397b-a17b": {
    strengths: ["Very large open-weight MoE, multimodal", "Included with your account"],
  ...
  "gemma-4-26b-a4b-it": {
    strengths: ["Light, fast, multimodal (open-weight)", "Included with your account"],
    weaknesses: ["Average capabilities"],
    bestFor: "Budget everyday tasks with no API key",
  },
  "mistral-medium-3.5-128b": {
    strengths: ["Balanced and multimodal", "Included with your account"],
    weaknesses: ["Proprietary model (hosted)"],
    bestFor: "Balanced general use with no API key",
  },
  "llama-3.3-70b-instruct": {
    strengths: ["Solid open-weight generalist", "Included with your account"],
  ...
  "pixtral-12b-2409": {
    strengths: ["Light and cheap multimodal", "Included with your account"],
    weaknesses: ["Average capabilities"],
    bestFor: "Budget vision with no API key",
  },
  "mistral-small-3.2-24b-instruct-2506": {
    strengths: ["Compact, multimodal, very cheap", "Included with your account"],
  ...
  "gpt-oss-120b": {
    strengths: ["OpenAI open weights, good performance/price", "Included with your account"],
    weaknesses: ["Text only"],
    bestFor: "Budget open-weight reasoning with no API key",
  },
  "gemma-3-27b-it": {
    strengths: ["Open-weight multimodal (Google)", "Included with your account"],
    weaknesses: ["Previous generation (Gemma 3)"],
    bestFor: "General-purpose vision with no API key",
  },
  "holo2-30b-a3b": {
    strengths: ["Open-weight multimodal MoE, fast", "Included with your account"],
